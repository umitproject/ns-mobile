...
public interface ScanCommunication {
    ...
    static final int RESP_SCAN_ID = 2; //arg1=id, {arg2=1 if true, arg2=0 if false}

    static final int RQST_START_SCAN = 3; //obj=Bundle: {string ScanArguments}
    ...
    static final int NOTIFY_SCAN_FINISHED = 15; //arg1=id, info=<scan results>
